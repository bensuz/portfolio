...
function Project({ title, description, tags, imageUrl }: ProjectsProbs) {
    ...
    return (
        ...
        >
            {" "}
            <section className="relative  bg-slate-300/60 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 sm:h-[20rem]  hover:bg-slate-400/50 group-even:pl-8">
                <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col items-start h-full sm:mt-auto sm:group-even:ml-[18rem]">
